  ...
  return (
    <div>
      ...
      <div style={styles.tabBar}>
        ...
        <TabButton label="Wealth Screening" active={activeTab === 'wealth'}  onClick={() => setActiveTab('wealth')} />
      </div>

      <div style={activeTab === 'wealth' ? { maxWidth: '860px' } : styles.panel}>
...
function WealthTab() {
  ...
  const ratingDesc = { 'A+': 'Exceptional capacity', 'A': 'Strong capacity', 'B+': 'Good capacity', 'B': 'Moderate capacity', 'B-': 'Below average', 'C+': 'Limited capacity', 'C': 'Low capacity' }

  return (
    <div>
      {/* Intro */}
      <div style={{ background: 'white', borderRadius: '12px', padding: '24px 28px', boxShadow: '0 2px 16px rgba(29,111,219,0.08)', border: '1px solid rgba(29,111,219,0.1)', marginBottom: '20px' }}>
        <h2 style={{ fontSize: '16px', fontWeight: '700', color: '#0c1a33', marginBottom: '6px', fontFamily: "'Space Grotesk', sans-serif" }}>Wealth Screening</h2>
        <p style={{ fontSize: '13px', color: '#6b7280', fontFamily: "'Inter', sans-serif", lineHeight: '1.6', marginBottom: '20px', maxWidth: '600px' }}>
          Look up a constituent's estimated wealth profile — net worth range, charitable giving capacity, real estate, and publicly recorded gifts — before you make an ask.
        </p>
        <div style={{ display: 'flex', gap: '10px', alignItems: 'flex-end' }}>
          <div>
            <label style={{ display: 'block', fontSize: '11px', fontWeight: '700', color: '#374151', textTransform: 'uppercase', letterSpacing: '0.04em', marginBottom: '5px', fontFamily: "'Inter', sans-serif" }}>
              Constituent #
            </label>
            <input
              value={custNo}
              ...
              style={{ padding: '9px 14px', border: '1px solid rgba(29,111,219,0.2)', borderRadius: '8px', fontSize: '14px', fontFamily: "'Inter', sans-serif", outline: 'none', width: '180px' }}
            />
          </div>
          <button
            ...
            style={{
              padding: '9px 22px', background: 'linear-gradient(135deg, #1d6fdb, #38bdf8)',
        ...
        {loading && (
          <p style={{ fontSize: '12px', color: '#9ca3af', marginTop: '10px', fontFamily: "'Inter', sans-serif", fontStyle: 'italic' }}>
            Querying wealth databases… checking public records…
          </p>
        )}
      </div>
      ...
      {/* Results */}
      {searched && profile && (
        <div style={{ background: 'white', borderRadius: '12px', padding: '24px 28px', boxShadow: '0 2px 16px rgba(29,111,219,0.08)', border: '1px solid rgba(29,111,219,0.1)' }}>
          {/* Header row */}
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '20px', flexWrap: 'wrap', gap: '12px' }}>
            <div>
              <p style={{ fontSize: '18px', fontWeight: '700', color: '#0c1a33', margin: 0, fontFamily: "'Space Grotesk', sans-serif" }}>{profile.name}</p>
              <p style={{ fontSize: '12px', color: '#9ca3af', margin: '2px 0 0', fontFamily: "'Inter', sans-serif" }}>Constituent #{custNo}</p>
            </div>
            <div style={{ textAlign: 'right' }}>
              <div style={{
                ...
                <span style={{ fontSize: '28px', fontWeight: '900', color: profile.ratingColor, fontFamily: "'Space Grotesk', sans-serif", lineHeight: 1 }}>{profile.rating}</span>
                <span style={{ fontSize: '10px', color: profile.ratingColor, fontWeight: '700', letterSpacing: '0.04em', marginTop: '2px', fontFamily: "'Inter', sans-serif" }}>
                  {ratingDesc[profile.rating] || 'Capacity rating'}
                </span>
              </div>
            </div>
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: '12px', marginBottom: '20px' }}>
            {[
              ...
              <div key={label} style={{ background: '#f8fafd', borderRadius: '8px', padding: '12px 14px', border: '1px solid rgba(29,111,219,0.08)' }}>
                <p style={{ fontSize: '10px', fontWeight: '700', letterSpacing: '0.06em', textTransform: 'uppercase', color: '#9ca3af', marginBottom: '4px', fontFamily: "'Inter', sans-serif" }}>{label}</p>
                <p style={{ fontSize: '13px', fontWeight: '600', color: '#0c1a33', margin: 0, fontFamily: "'Inter', sans-serif" }}>{value}</p>
              </div>
            ))}
          </div>
          ...
          {profile.publicGifts && profile.publicGifts.length > 0 && (
            <div style={{ marginBottom: '16px' }}>
              <p style={{ fontSize: '11px', fontWeight: '700', letterSpacing: '0.06em', textTransform: 'uppercase', color: '#9ca3af', marginBottom: '8px', fontFamily: "'Inter', sans-serif" }}>
                Publicly Recorded Gifts to Other Orgs
              </p>
              <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
                {profile.publicGifts.map((g, i) => (
                  <span key={i} style={{ background: 'rgba(29,111,219,0.07)', border: '1px solid rgba(29,111,219,0.15)', borderRadius: '100px', padding: '4px 12px', fontSize: '12px', color: '#1d6fdb', fontFamily: "'Inter', sans-serif", fontWeight: '500' }}>
                    {g.org} — {g.amount}
                  </span>
                ))}
              </div>
          ...
          {profile.publicGifts && profile.publicGifts.length === 0 && (
            <p style={{ fontSize: '12px', color: '#9ca3af', fontStyle: 'italic', fontFamily: "'Inter', sans-serif", marginBottom: '16px' }}>No publicly recorded gifts to other organizations found.</p>
          )}

          {/* Analyst note */}
          <div style={{ background: 'rgba(29,111,219,0.05)', borderRadius: '8px', padding: '12px 14px', border: '1px solid rgba(29,111,219,0.12)' }}>
            <p style={{ fontSize: '11px', fontWeight: '700', letterSpacing: '0.06em', textTransform: 'uppercase', color: '#1d6fdb', marginBottom: '4px', fontFamily: "'Inter', sans-serif" }}>Analyst Note</p>
            <p style={{ fontSize: '13px', color: '#374151', margin: 0, fontFamily: "'Inter', sans-serif", lineHeight: '1.6' }}>{profile.notes}</p>
          </div>
        </div>
      )}
    </div>
